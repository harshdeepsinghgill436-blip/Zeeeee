...
const SEQUENCES = [
  ...
  {
    id: 2,
    subject: "Your competitor just closed your deal",
    body: `They didn't work harder. They just saw the signal first.\n\nLeadSynth tracks 40+ platforms in real time — Reddit posts, LinkedIn activity, hiring signals, tool switches — and hands you verified buyers before anyone else reaches out.\n\nWhile you're building lists, they're closing deals.\n\n10 free leads. No card. See the difference.\n→ https://lead-synth-pro.vercel.app/`,
    followups: [
      { subject: "They're already using this", body: `Intent data isn't new. Your competitors are already on it.\n\nThe only question is whether you want to catch up or keep losing deals you never saw.\n→ https://lead-synth-pro.vercel.app/` },
      { subject: "First mover wins every time", body: `The person who reaches out first to a warm buyer wins 80% of the time.\n\nLeadSynth puts you first. 10 free leads to see it live.\n→ https://lead-synth-pro.vercel.app/` },
      { subject: "The edge you're missing", body: `Your offer is good. Your timing is off.\n\nLeadSynth fixes the timing. That's the whole game.\n→ https://lead-synth-pro.vercel.app/` },
      { subject: "Still grinding cold outreach?", body: `There's a version of your business where every outreach lands because the person was already looking.\n\nLeadSynth builds that version. 10 free leads.\n→ https://lead-synth-pro.vercel.app/` },
      { subject: "Before I stop following up", body: `Someone right now is posting about needing what you sell.\n\nLeadSynth shows you who. 10 leads free. No card.\n→ https://lead-synth-pro.vercel.app/` },
    ]
  },
  {
    id: 3,
    subject: "You don't have a lead problem",
    body: `You have a timing problem.\n\nYou're reaching out too early — they're not ready. Too late — someone else already closed them.\n\nLeadSynth tracks real-time intent signals across 40+ platforms so you know exactly when someone is actively looking for what you sell.\n\nNot last month's data. Right now.\n\n10 free leads. No card needed.\n→ https://lead-synth-pro.vercel.app/`,
    followups: [
      { subject: "The 72 hour window", body: `Most buying decisions happen in a 72 hour window.\n\nLeadSynth shows you who's in that window right now.\n\n10 free leads to see it.\n→ https://lead-synth-pro.vercel.app/` },
      { subject: "Wrong time = no reply", body: `It's not your email. It's not your offer. It's your timing.\n\nLeadSynth fixes timing. That's it.\n→ https://lead-synth-pro.vercel.app/` },
      { subject: "Real buyers. Right now.", body: `Not a scraped list. Not old data.\n\nPeople posting today on Reddit, LinkedIn, Upwork asking for your exact service.\n\nSee them free.\n→ https://lead-synth-pro.vercel.app/` },
      { subject: "This is why cold email dies", body: `Cold email fails because you're sending to people who aren't thinking about buying.\n\nLeadSynth sends you to people who are.\n→ https://lead-synth-pro.vercel.app/` },
      { subject: "Last nudge", body: `10 free leads. No card. 2 minutes.\n\nSee who's actively looking for you right now.\n→ https://lead-synth-pro.vercel.app/` },
    ]
  },
  {
    id: 4,
    subject: "400M people post on Reddit every month",
    body: `Some of them are asking for exactly what you sell.\n\nRight now. Today.\n\nLeadSynth scans Reddit, LinkedIn, Upwork, Twitter, Facebook Groups, Quora, ProductHunt, Discord and 30+ more — extracts the ones asking for your service — and hands you their verified contact info.\n\nYou just show up at the right moment.\n\n10 free leads. No credit card.\n→ https://lead-synth-pro.vercel.app/`,
    followups: [
      { subject: "They asked. Did you answer?", body: `Someone posted today asking for your exact service.\n\nLeadSynth found them. Did you reach out?\n\n10 free leads to start.\n→ https://lead-synth-pro.vercel.app/` },
      { subject: "40+ platforms. One dashboard.", body: `Reddit. LinkedIn. Upwork. Twitter. Discord. Quora.\n\nLeadSynth watches all of them so you don't have to.\n\nTest it free.\n→ https://lead-synth-pro.vercel.app/` },
      { subject: "The post that could close", body: `Every day there are posts out there that could turn into your next deal.\n\nLeadSynth finds them before they go cold.\n→ https://lead-synth-pro.vercel.app/` },
      { subject: "Warm beats cold every time", body: `A warm lead who posted asking for help converts 5x better than a cold contact.\n\nLeadSynth gives you warm. Free to test.\n→ https://lead-synth-pro.vercel.app/` },
      { subject: "Still here?", body: `10 leads. Free. No card. Takes 2 minutes.\n\nJust go see who's looking for you right now.\n→ https://lead-synth-pro.vercel.app/` },
    ]
  },
  {
    id: 5,
    subject: "Stop paying for dead data",
    body: `Most lead databases are 6-12 months old.\n\nBy the time you buy the list, the companies have changed tools, hired someone else, or already signed a contract.\n\nLeadSynth tracks live signals — hiring activity, tool switches, funding rounds, real-time posts — so every lead you get is in motion right now.\n\nSee the difference yourself. 10 leads free.\n→ https://lead-synth-pro.vercel.app/`,
    followups: [
      { subject: "Fresh vs stale", body: `Stale data = ignored emails.\nFresh signals = closed deals.\n\nLeadSynth gives you fresh. Always.\n→ https://lead-synth-pro.vercel.app/` },
      { subject: "When did you last close from a list?", body: `Cold lists have a 1-3% reply rate on a good day.\n\nWarm intent leads? Completely different game.\n\nTest the difference free.\n→ https://lead-synth-pro.vercel.app/` },
      { subject: "Live signals. Not old records.", body: `LeadSynth doesn't pull from a database.\n\nIt scans the internet live — right now — and finds people actively looking.\n\n10 free leads to see it.\n→ https://lead-synth-pro.vercel.app/` },
      { subject: "Your next client is online right now", body: `Posting. Asking. Looking for exactly what you offer.\n\nLeadSynth finds them in real time.\n→ https://lead-synth-pro.vercel.app/` },
      { subject: "Last one", body: `Dead data costs you deals you never knew you lost.\n\nLive intent data changes everything. See it free.\n→ https://lead-synth-pro.vercel.app/` },
    ]
  },
  {
    id: 6,
    subject: "What if you only reached out to people already halfway to buying?",
    body: `No convincing. No nurturing. No cold shoulder.\n\nJust people who already know they have a problem — and are actively looking for someone like you to solve it.\n\nLeadSynth surfaces them from Reddit, LinkedIn, Upwork and 37 other platforms. Verified email. Pain point. Platform. All in one export.\n\n10 free leads. No card.\n→ https://lead-synth-pro.vercel.app/`,
    followups: [
      { subject: "Halfway there already", body: `The hardest part of sales is creating desire.\n\nLeadSynth gives you people who already have it.\n\nTest free.\n→ https://lead-synth-pro.vercel.app/` },
      { subject: "They're already looking", body: `You don't need to convince them they have a problem.\n\nThey already know. They already posted about it.\n\nYou just need to show up.\n→ https://lead-synth-pro.vercel.app/` },
      { subject: "Pain point included", body: `Every warm lead comes with what they said, where they said it, and why they need help.\n\nYou walk in already knowing everything.\n→ https://lead-synth-pro.vercel.app/` },
      { subject: "The easiest close you'll ever make", body: `When someone already wants what you sell — the close is just a conversation.\n\nLeadSynth finds those people. 10 free.\n→ https://lead-synth-pro.vercel.app/` },
      { subject: "Still cold prospecting?", body: `There's a warmer way.\n\n10 leads free. No card.\n→ https://lead-synth-pro.vercel.app/` },
    ]
  },
  {
    id: 7,
    subject: "Your outreach isn't bad. Your list is.",
    body: `Great copy. Perfect subject line. Solid offer.\n\nSent to someone who doesn't need what you sell right now.\n\nThat's the problem.\n\nLeadSynth gives you people actively looking for your service today. The same outreach hits completely different when the timing is right.\n\n10 free leads. See for yourself.\n→ https://lead-synth-pro.vercel.app/`,
    followups: [
      { subject: "Same email. Different results.", body: `The email that gets ignored on a cold list gets replied to by a warm lead.\n\nSame words. Different timing.\n\nLeadSynth gives you the timing.\n→ https://lead-synth-pro.vercel.app/` },
      { subject: "It's not your copy", body: `You've tested subject lines. You've A/B'd your CTA.\n\nThe problem was never the email. It was who you were sending it to.\n→ https://lead-synth-pro.vercel.app/` },
      { subject: "Right person. Right time.", body: `That's the whole formula.\n\nLeadSynth handles both. 10 free leads.\n→ https://lead-synth-pro.vercel.app/` },
      { subject: "Better list = better results", body: `Stop blaming the copy.\n\nStart with people who actually need you right now.\n\nTest free.\n→ https://lead-synth-pro.vercel.app/` },
      { subject: "One last thing", body: `10 leads. Free. No card.\n\nJust try it and see if your results change.\n→ https://lead-synth-pro.vercel.app/` },
    ]
  },
  {
    id: 8,
    subject: "Hiring signals. Funding rounds. Tool switches.",
    body: `These are the moments companies are most likely to buy.\n\nWhen a company just raised — they spend. When they're hiring fast — they need tools. When they switch tools — there's a gap.\n\nLeadSynth tracks all of it. In real time. Across thousands of companies.\n\nSo when you reach out, it's not random. It's perfectly timed.\n\n10 free leads. No card.\n→ https://lead-synth-pro.vercel.app/`,
    followups: [
      { subject: "They just raised. Now what?", body: `Companies that just raised are 3x more likely to buy new tools in the next 90 days.\n\nLeadSynth tracks funding signals in real time.\n→ https://lead-synth-pro.vercel.app/` },
      { subject: "Hiring = buying signal", body: `When a company posts a job — they're growing. Growing companies buy.\n\nLeadSynth catches this signal before anyone else.\n→ https://lead-synth-pro.vercel.app/` },
      { subject: "The signals most people miss", body: `Tool switches. Team expansions. New hires in key roles.\n\nAll buying signals. All tracked by LeadSynth.\n\nTest free.\n→ https://lead-synth-pro.vercel.app/` },
      { subject: "Not guesses. Signals.", body: `LeadSynth doesn't predict who might buy.\n\nIt shows you who's already moving. Real signals. Real timing.\n→ https://lead-synth-pro.vercel.app/` },
      { subject: "Last signal from me", body: `10 free leads. No card. See the signals yourself.\n→ https://lead-synth-pro.vercel.app/` },
    ]
  },
  {
    id: 9,
    subject: "1 credit. 1 verified founder. Direct contact.",
    body: `Name. Email. LinkedIn. Company. Phone.\n\nAll verified. All real. All decision makers.\n\nLeadSynth gives you B2B contacts that are LinkedIn-verified with direct email — not some generic info@ address that goes nowhere.\n\nYou tell us the niche, location, and service. We hand you the founder.\n\n10 free credits. No card needed.\n→ https://lead-synth-pro.vercel.app/`,
    followups: [
      { subject: "Real decision makers only", body: `No gatekeepers. No info@ emails. No LinkedIn requests that go unanswered.\n\nDirect founder contacts. Verified.\n→ https://lead-synth-pro.vercel.app/` },
      { subject: "Your niche. Your location. Your leads.", body: `LeadSynth doesn't give you a generic list.\n\nYou specify exactly who you want. We find them.\n\n10 free to test.\n→ https://lead-synth-pro.vercel.app/` },
      { subject: "Verified email or it doesn't count", body: `Bounced emails kill your domain reputation.\n\nEvery LeadSynth contact is verified before it reaches you.\n→ https://lead-synth-pro.vercel.app/` },
      { subject: "Founder name. Verified title. Direct line.", body: `That's what every cold lead from LeadSynth includes.\n\nNo guessing. No scraping. Real data.\n→ https://lead-synth-pro.vercel.app/` },
      { subject: "Last one", body: `10 free verified founder contacts.\n\nNo card. Takes 2 minutes.\n→ https://lead-synth-pro.vercel.app/` },
    ]
  },
  {
    id: 10,
    subject: "The leads that were going to buy anyway",
    body: `Some people are just ready.\n\nThey have the budget. They have the problem. They're actively looking.\n\nYou just never knew they existed.\n\nLeadSynth finds them — across Reddit, LinkedIn, Upwork, Discord, Quora and 35 more platforms — and hands you everything you need to close.\n\nThey were going to buy from someone. Make sure it's you.\n\n10 free leads. No card.\n→ https://lead-synth-pro.vercel.app/`,
    followups: [
      { subject: "They were going to buy anyway", body: `The only question was who they'd buy from.\n\nLeadSynth makes sure it's you.\n\n10 free leads.\n→ https://lead-synth-pro.vercel.app/` },
      { subject: "Budget. Problem. Looking.", body: `That's the perfect lead.\n\nLeadSynth finds them in real time across 40+ platforms.\n\nTest free.\n→ https://lead-synth-pro.vercel.app/` },
      { subject: "Someone else is closing them", body: `Right now. While you're reading this.\n\nA warm lead just got claimed by someone who saw the signal first.\n\nDon't let that keep happening.\n→ https://lead-synth-pro.vercel.app/` },
      { subject: "The easiest pipeline you'll ever build", body: `People already looking for what you sell.\n\nVerified contacts. Live signals. One click export.\n\nLeadSynth. Free to start.\n→ https://lead-synth-pro.vercel.app/` },
      { subject: "Final email", body: `10 leads. Free. No card. 2 minutes.\n\nFind the buyers who were going to buy anyway.\n→ https://lead-synth-pro.vercel.app/` },
    ]
  },
]

const DAILY_LIMIT_PER_ACCOUNT = 300
...
async function getDailyCount(brevoSender: string): Promise<number> {
  const today = new Date().toISOString().split('T')[0]
  const { count } = await supabase
    .from('email_logs')
    .select('*', { count: 'exact', head: true })
    .eq('brevo_sender', brevoSender)
...
serve(async () => {
  try {
    ...
    // Get daily counts per brevo account
    const dailyCounts: Record<string, number> = {}

    // PRIORITY 1: Fire follow-ups that are due
    ...
    for (const lead of (followupLeads || [])) {
      ...
      if (!dailyCounts[sender]) dailyCounts[sender] = await getDailyCount(sender)
      if (dailyCounts[sender] >= DAILY_LIMIT_PER_ACCOUNT) continue
    ...
    // PRIORITY 2: Fire main emails (step 0) with remaining slots
    ...
    return new Response(JSON.stringify({ ok: true, fired: fired.length, emails: fired }), {
